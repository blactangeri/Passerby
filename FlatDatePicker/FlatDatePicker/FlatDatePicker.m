...
// Constants times :
#define kFlatDatePickerAnimationDuration 0.8
...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColorButtonValid = [UIColor colorWithRed:58.0/255.0 green:58.0/255.0 blue:58.0/255.0 alpha:1.0];
        self.backgroundColorScrollView = [UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:1.0];
        self.backgroundColorLines = [UIColor colorWithRed:234.0/255.0 green:0.0/255.0 blue:42.0/255.0 alpha:1.0];
        ...
        self.fontColorLabelSelected  = [UIColor colorWithRed:234.0/255.0 green:0/255.0 blue:42/255.0 alpha:1.0];
        
        // Default fonts.
        self.fontTitle = [UIFont fontWithName:@"din-light" size:20.0];
        self.fontLabel = [UIFont fontWithName:@"din-light" size:16.0];
        self.fontLabelSelected = [UIFont fontWithName:@"DIN" size:24.0];
...
- (void)show {
    ...
    if (_parentView != nil) {
        ...
        self.frame = CGRectMake(self.frame.origin.x, (_parentView.frame.size.height - self.frame.size.height) / 2, self.frame.size.width, self.frame.size.height);

        if (IS_PHONE) [UIView commitAnimations];
        
        _buttonValid = [[UIButton alloc] initWithFrame:CGRectMake(0.0, _parentView.frame.size.height - kFlatDatePickerHeaderHeight, self.frame.size.width, kFlatDatePickerHeaderHeight)];
        _buttonValid.hidden = NO;
        ...
        [_parentView addSubview:_buttonValid];
        
        _buttonValid.alpha = 0.0;
        [UIView animateWithDuration:2.5 animations:^{
            _buttonValid.alpha = 1.0;
        }];
    }
}
...
- (void)show2 {
    ...
    if (_parentView != nil) {
        ...
        _buttonValid = [[UIButton alloc] initWithFrame:CGRectMake(0.0, _parentView.frame.size.height - kFlatDatePickerHeaderHeight,
                                                                  self.frame.size.width, kFlatDatePickerHeaderHeight)];
        _buttonValid.hidden = NO;
        _buttonValid.backgroundColor = kFlatDatePickerBackgroundColorButtonValid;
        [_buttonValid setImage:[UIImage imageNamed:kFlatDatePickerIconValid] forState:UIControlStateNormal];
        [_buttonValid addTarget:self action:@selector(actionButtonValid) forControlEvents:UIControlEventTouchUpInside];
